...
<?php $__env->startSection('content'); ?>
    ...
    <div style="display:flex;justify-content:flex-end;margin-bottom:1rem;">
        <a href="<?php echo e(route('dashboard.exportPdf')); ?>" class="btn btn-secondary btn-sm" style="display:inline-flex;align-items:center;gap:0.4rem;">
    ...
    <div class="stats-grid">
        <div class="stat-card">
            ...
            <div class="stat-info">
                <h3><?php echo e($totalEmployees); ?></h3>
        ...
        <div class="stat-card">
            ...
            <div class="stat-info">
                <h3><?php echo e($totalDepartments); ?></h3>
        ...
        <div class="stat-card">
            ...
            <div class="stat-info">
                <h3><?php echo e(number_format($totalPayrollThisMonth)); ?></h3>
                <div class="stat-label">Payroll This Month (NLE)</div>
            </div>
            <?php if($totalPayrollThisMonth > 0): ?>
                <a href="<?php echo e(route('payroll.index')); ?>" class="stat-action-badge stat-action-badge-green">View</a>
            <?php endif; ?>
        </div>
        ...
        <div class="stat-card">
            ...
            <?php if($pendingLeaves > 0): ?>
                <a href="<?php echo e(route('leaves.index')); ?>" class="stat-action-badge">Review</a>
            <?php endif; ?>
        </div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-info">
                <h3><?php echo e($pendingOvertimes); ?></h3>
                <div class="stat-label">Pending Overtime</div>
            </div>
            <?php if($pendingOvertimes > 0): ?>
                <a href="<?php echo e(route('overtime.index')); ?>" class="stat-action-badge">Review</a>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem;">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <a href="<?php echo e(route('payroll.index')); ?>" class="btn btn-sm btn-secondary">View All</a>
            </div>

            <?php if($currentPayroll): ?>
                <div style="text-align: center; padding: 1rem 0;">
                    <div style="font-size: 1.6rem; font-weight: 700; color: var(--text-primary)">
                        <?php echo e($currentPayroll->periodLabel()); ?>

                    </div>
                    <div class="mt-1">
                        <?php if($currentPayroll->status === 'paid'): ?>
                            <span class="badge badge-success">Paid</span>
                        <?php elseif($currentPayroll->status === 'processed'): ?>
            ...
            <?php else: ?>
                <div class="empty-state">
                    ...
                    <a href="<?php echo e(route('payroll.create')); ?>" class="btn btn-primary btn-sm mt-2">Process Payroll</a>
                </div>
            <?php endif; ?>
        </div>
        ...
        <div class="card">
            ...
            <div style="display: flex; flex-direction: column; gap: 0.75rem;">
                <a href="<?php echo e(route('employees.create')); ?>" class="btn btn-secondary">
                ...
                <a href="<?php echo e(route('payroll.create')); ?>" class="btn btn-secondary">
    ...
    <div style="display:grid;grid-template-columns:1fr 2fr;gap:1.5rem;margin-top:1.5rem">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <span style="font-size:0.72rem;padding:0.15rem 0.5rem;border-radius:99px;background:<?php echo e($payrollForecast['confidence']==='high'?'#22c55e22':($payrollForecast['confidence']==='medium'?'#f59e0b22':'#6b728022')); ?>;color:<?php echo e($payrollForecast['confidence']==='high'?'#22c55e':($payrollForecast['confidence']==='medium'?'#f59e0b':'#9ca3af')); ?>">
                    <?php echo e(ucfirst($payrollForecast['confidence'])); ?> confidence
                </span>
            </div>
            <div style="text-align:center;padding:1rem 0 0.5rem;">
                ...
                <div style="font-size:1.9rem;font-weight:800;color:var(--accent);margin:0.25rem 0;">
                    NLE <?php echo e(number_format($payrollForecast['total'], 0)); ?>

                </div>
                <div style="font-size:0.75rem;color:var(--text-muted);"><?php echo e($payrollForecast['employees']); ?> active employees</div>
            </div>
            <div style="border-top:1px solid var(--border-color);padding-top:0.75rem;margin-top:0.5rem;display:flex;flex-direction:column;gap:0.35rem;">
                <div style="display:flex;justify-content:space-between;font-size:0.78rem;">
                    ...
                    <span>NLE <?php echo e(number_format($payrollForecast['base'], 0)); ?></span>
                </div>
                <?php if($payrollForecast['overtime'] > 0): ?>
                <div style="display:flex;justify-content:space-between;font-size:0.78rem;">
                    <span style="color:var(--text-muted);">Avg Overtime</span>
                    <span style="color:#f59e0b;">+ NLE <?php echo e(number_format($payrollForecast['overtime'], 0)); ?></span>
                </div>
                <?php endif; ?>
                <?php if($payrollForecast['bonus'] > 0): ?>
                <div style="display:flex;justify-content:space-between;font-size:0.78rem;">
                    <span style="color:var(--text-muted);">Avg Bonuses</span>
                    <span style="color:#22c55e;">+ NLE <?php echo e(number_format($payrollForecast['bonus'], 0)); ?></span>
                </div>
                <?php endif; ?>
            </div>
            <?php if(count($payrollForecast['history']) > 0): ?>
            <div style="margin-top:0.75rem;border-top:1px solid var(--border-color);padding-top:0.75rem;">
                ...
                <div style="display:flex;gap:0.4rem;align-items:flex-end;height:36px;">
                    <?php $maxHist = max(1, max(array_column($payrollForecast['history'], 'total'))); ?>
                    <?php $__currentLoopData = $payrollForecast['history']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $h): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div style="flex:1;display:flex;flex-direction:column;align-items:center;gap:2px;">
                            <div title="<?php echo e($h['label']); ?>: NLE <?php echo e(number_format($h['total'])); ?>"
                                 style="height:<?php echo e($h['total'] > 0 ? max(4, round(($h['total']/$maxHist)*28)) : 2); ?>px;width:100%;background:var(--accent);border-radius:3px 3px 0 0;opacity:0.6;"></div>
                            <div style="font-size:0.6rem;color:var(--text-muted);white-space:nowrap;"><?php echo e($h['label']); ?></div>
                        </div>
        ...
        <div class="card">
            ...
            <?php if(empty($attendanceInsights)): ?>
            ...
            <?php else: ?>
                <div style="display:flex;flex-direction:column;gap:0.5rem;">
                    <?php $__currentLoopData = $attendanceInsights; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $insight): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                            $ic = $insight['severity'] === 'warning' ? '#ef4444' : '#00e5ff';
                            $ib = $insight['severity'] === 'warning' ? '#ef444415' : '#00e5ff10';
                        ?>
                        <div style="display:flex;align-items:flex-start;gap:0.65rem;padding:0.6rem 0.85rem;background:<?php echo e($ib); ?>;border-left:3px solid <?php echo e($ic); ?>;border-radius:0 6px 6px 0;">
                            <?php if($insight['severity'] === 'warning'): ?>
                                <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="<?php echo e($ic); ?>" stroke-width="2" style="flex-shrink:0;margin-top:1px"><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>
                            <?php else: ?>
                                <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="<?php echo e($ic); ?>" stroke-width="2" style="flex-shrink:0;margin-top:1px"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>
                            <?php endif; ?>
                            <span style="font-size:0.82rem;color:var(--text-secondary);line-height:1.45;"><?php echo e($insight['message']); ?></span>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            <?php endif; ?>
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:1.5rem;margin-top:1.5rem">
                        ...
                        <li style="display:flex;align-items:center;gap:0.75rem;padding:0.55rem 0;border-bottom:1px solid var(--border-color)">
                            <?php if($event['type'] === 'birthday'): ?>
                                ...
                                <div style="flex:1;min-width:0">
                                    <div style="font-weight:600;font-size:0.85rem;white-space:nowrap;overflow:hidden;text-overflow:ellipsis"><?php echo e($event['name']); ?></div>
                                    <div style="font-size:0.75rem;color:var(--text-muted)">Birthday — <?php echo e(\Carbon\Carbon::parse($event['date'])->format('d M')); ?></div>
                                </div>
                            ...
                            <?php elseif($event['type'] === 'anniversary'): ?>
                                ...
                                <div style="flex:1;min-width:0">
                                    <div style="font-weight:600;font-size:0.85rem;white-space:nowrap;overflow:hidden;text-overflow:ellipsis"><?php echo e($event['name']); ?></div>
                                    <div style="font-size:0.75rem;color:var(--text-muted)">Work Anniversary — <?php echo e($event['detail']); ?> — <?php echo e(\Carbon\Carbon::parse($event['date'])->format('d M')); ?></div>
                                </div>
                            ...
                            <?php else: ?>
                                ...
                                <div style="flex:1;min-width:0">
                                    <div style="font-weight:600;font-size:0.85rem;white-space:nowrap;overflow:hidden;text-overflow:ellipsis"><?php echo e($event['name']); ?></div>
                                    <div style="font-size:0.75rem;color:var(--text-muted)"><?php echo e($event['detail']); ?> expires <?php echo e(\Carbon\Carbon::parse($event['date'])->format('d M')); ?></div>
                                </div>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <a href="<?php echo e(route('audit.index')); ?>" class="btn btn-sm btn-secondary">View All</a>
            </div>
                ...
                <div style="position:relative;padding-left:1.25rem">
                    ...
                    <?php $__currentLoopData = $recentActivity; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div style="position:relative;padding:0 0 0.85rem 1rem;margin-bottom:0">
                            <div style="position:absolute;left:-5px;top:4px;width:10px;height:10px;border-radius:50%;background:<?php echo e($eventColor); ?>;border:2px solid var(--card-bg)"></div>
                            <div style="font-size:0.82rem;font-weight:600;color:var(--text-primary);line-height:1.3">
                                <?php echo e($activity->causer?->name ?? 'System'); ?>

                                <span style="font-weight:400;color:var(--text-secondary)">
                                    <?php echo e($activity->event ?? 'logged'); ?>

                                    <?php echo e(class_basename($activity->subject_type ?? '')); ?><?php if($activity->subject_id): ?> #<?php echo e($activity->subject_id); ?><?php endif; ?>
                                </span>
                            </div>
    ...
    <div class="card mt-3">
        <div class="card-header">
            ...
            <a href="<?php echo e(route('leaves.index')); ?>" class="btn btn-sm btn-secondary">View All</a>
        </div>
        <div class="table-wrapper">
            <table>
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $pendingLeaveRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $leave): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    <form action="<?php echo e(route('leaves.approve', $leave)); ?>" method="POST" style="margin:0">
                                        <?php echo csrf_field(); ?>
                                        <button type="submit" class="btn btn-success btn-sm">Approve</button>
                                    </form>
                                    <form action="<?php echo e(route('leaves.reject', $leave)); ?>" method="POST" style="margin:0"
                                          data-confirm="Reject leave request for <?php echo e($leave->employee->user->name ?? 'this employee'); ?>?">
                                        <?php echo csrf_field(); ?>
    ...
    <div class="card mt-3">
        <div class="card-header">
            ...
            <a href="<?php echo e(route('employees.index')); ?>" class="btn btn-sm btn-secondary">View All</a>
        </div>
        <div class="table-wrapper">
            <table>
                <thead>
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $recentEmployees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td class="text-accent"><?php echo e($emp->employee_id); ?></td>
                            <td><?php echo e($emp->user->name); ?></td>
                            <td><?php echo e($emp->department->name); ?></td>
                            <td><?php echo e($emp->position); ?></td>
                            <td>
                                <span class="badge <?php echo e($emp->status === 'active' ? 'badge-success' : 'badge-danger'); ?>">
                        ...
                        <tr>
                            <td colspan="5">
                                <div class="empty-state">
                                    ...
                                    <a href="<?php echo e(route('employees.create')); ?>" class="btn btn-primary btn-sm mt-2">Add Employee</a>
                                </div>
                            </td>
                        </tr>
                    <?php endif; ?>
...
const payrollData    = <?php echo json_encode($payrollChartData, 15, 512) ?>;
const deptData       = <?php echo json_encode($deptData, 15, 512) ?>;
const attendanceData = <?php echo json_encode($attendanceChartData, 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ishma\Music\iims\resources\views/dashboard/admin.blade.php ENDPATH**/ ?>