...
?>
    <div class="app-layout">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="<?php echo e(route('dashboard')); ?>" data-label="Dashboard" class="nav-link <?php echo e(request()->routeIs('dashboard') ? 'active' : ''); ?>">
                ...
                <?php if(auth()->user()->isAdmin()): ?>
                    ...
                    <a href="<?php echo e(route('employees.index')); ?>" data-label="Employees" class="nav-link <?php echo e(request()->routeIs('employees.*') ? 'active' : ''); ?>">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
                        <span>Employees</span>
                    </a>
                    <a href="<?php echo e(route('departments.index')); ?>" data-label="Departments" class="nav-link <?php echo e(request()->routeIs('departments.*') ? 'active' : ''); ?>">
                ...
                <a href="<?php echo e(route('attendance.index')); ?>" data-label="Attendance" class="nav-link <?php echo e(request()->routeIs('attendance.*') ? 'active' : ''); ?>">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/><path d="M8 14h.01"/><path d="M12 14h.01"/><path d="M16 14h.01"/><path d="M8 18h.01"/><path d="M12 18h.01"/></svg>
                    <span>Attendance</span>
                </a>
                <a href="<?php echo e(route('leaves.index')); ?>" data-label="Leave" class="nav-link <?php echo e(request()->routeIs('leaves.*') ? 'active' : ''); ?>">
                    ...
                    <span>Leave</span>
                    <?php if($sidebarLeaves > 0): ?>
                        <span class="nav-badge"><?php echo e($sidebarLeaves > 99 ? '99+' : $sidebarLeaves); ?></span>
                    <?php endif; ?>
                </a>

                <?php if($isAdminOrManager): ?>
                    
                    <a href="<?php echo e(route('overtime.index')); ?>" data-label="Overtime" class="nav-link <?php echo e(request()->routeIs('overtime.*') ? 'active' : ''); ?>">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
                        <span>Overtime</span>
                        <?php if($sidebarOT > 0): ?>
                            <span class="nav-badge nav-badge-purple"><?php echo e($sidebarOT > 99 ? '99+' : $sidebarOT); ?></span>
                        <?php endif; ?>
                    </a>
                <?php endif; ?>

                <?php if($isAdmin): ?>
                    <a href="<?php echo e(route('payroll.index')); ?>" data-label="Payroll" class="nav-link <?php echo e(request()->routeIs('payroll.*') ? 'active' : ''); ?>">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>
                        <span>Payroll</span>
                    </a>
                    <a href="<?php echo e(route('tax.index')); ?>" data-label="Tax &amp; Deductions" class="nav-link <?php echo e(request()->routeIs('tax.*') ? 'active' : ''); ?>">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>
                        <span>Tax &amp; Deductions</span>
                    </a>
                    <a href="<?php echo e(route('reports.index')); ?>" data-label="Reports" class="nav-link <?php echo e(request()->routeIs('reports.*') ? 'active' : ''); ?>">
                    ...
                    <a href="<?php echo e(route('audit.index')); ?>" data-label="Audit Log" class="nav-link <?php echo e(request()->routeIs('audit.*') ? 'active' : ''); ?>">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>
                        <span>Audit Log</span>
                    </a>
                    <a href="<?php echo e(route('queue.monitor')); ?>" data-label="Queue Monitor" class="nav-link <?php echo e(request()->routeIs('queue.*') ? 'active' : ''); ?>">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
                        <span>Queue Monitor</span>
                    </a>
                    <a href="<?php echo e(route('settings.index')); ?>" data-label="Settings" class="nav-link <?php echo e(request()->routeIs('settings.*') ? 'active' : ''); ?>">
                    ...
                    <a href="<?php echo e(route('bonuses.index')); ?>" data-label="Bonuses" class="nav-link <?php echo e(request()->routeIs('bonuses.*') ? 'active' : ''); ?>">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>
                        <span>Bonuses</span>
                    </a>
                    <a href="<?php echo e(route('performance.index')); ?>" data-label="Performance" class="nav-link <?php echo e(request()->routeIs('performance.*') ? 'active' : ''); ?>">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg>
                        <span>Performance</span>
                    </a>
                    <a href="<?php echo e(route('holidays.index')); ?>" data-label="Holidays" class="nav-link <?php echo e(request()->routeIs('holidays.*') ? 'active' : ''); ?>">
                    ...
                    <a href="<?php echo e(route('profile-updates.index')); ?>" data-label="Profile Updates" class="nav-link <?php echo e(request()->routeIs('profile-updates.index') ? 'active' : ''); ?>">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
                        <span>Profile Updates</span>
                        <?php if($sidebarProfileUpdates > 0): ?>
                            <span class="nav-badge nav-badge-orange"><?php echo e($sidebarProfileUpdates > 99 ? '99+' : $sidebarProfileUpdates); ?></span>
                        <?php endif; ?>
                    </a>
                <?php endif; ?>
                ...
                <?php if($isManager): ?>
                    ...
                    <a href="<?php echo e(route('performance.index')); ?>" data-label="Team Reviews" class="nav-link <?php echo e(request()->routeIs('performance.*') ? 'active' : ''); ?>">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg>
                        <span>Team Reviews</span>
                    </a>
                <?php endif; ?>

                <a href="<?php echo e(route('payslips.index')); ?>" data-label="My Payslips" class="nav-link <?php echo e(request()->routeIs('payslips.*') ? 'active' : ''); ?>">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>
                    <span>My Payslips</span>
                </a>
                <?php if(!auth()->user()->isAdmin()): ?>
                    <a href="<?php echo e(route('performance.index')); ?>" data-label="My Reviews" class="nav-link <?php echo e(request()->routeIs('performance.*') ? 'active' : ''); ?>">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg>
                        <span>My Reviews</span>
                    </a>
                <?php endif; ?>
                <?php if(auth()->user()->isEmployee()): ?>
                    <a href="<?php echo e(route('profile-updates.create')); ?>" data-label="Update Profile" class="nav-link <?php echo e(request()->routeIs('profile-updates.create') ? 'active' : ''); ?>">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
                    ...
                    <div class="notif-dropdown" id="notifDropdown">
                        <button class="topbar-icon-btn" onclick="toggleNotifDropdown(event)" title="Notifications" aria-expanded="false" aria-haspopup="true">
                            ...
                            <?php if($unreadCount > 0): ?>
                                <span class="notif-badge"><?php echo e($unreadCount > 9 ? '9+' : $unreadCount); ?></span>
                            <?php endif; ?>
                        </button>
                        ...
                        <div class="notif-panel" id="notifPanel" role="menu">
                            <div class="notif-panel-header">
                                ...
                                <?php if($unreadCount > 0): ?>
                                    <form action="<?php echo e(route('notifications.readAll')); ?>" method="POST" style="margin:0">
                                        <?php echo csrf_field(); ?>
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $unreadNotifs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notif): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <?php
                                    $nUrl = $notif->data['url'] ?? route('notifications.index');
                                    $nIcon = $notif->data['icon'] ?? 'info';
                                ?>
                                <a href="<?php echo e(route('notifications.read', $notif->id)); ?>?redirect=<?php echo e(urlencode($nUrl)); ?>"
                                   class="notif-item" role="menuitem">
                                    <div class="notif-item-icon notif-icon-<?php echo e($nIcon); ?>">
                                        <?php if($nIcon === 'success'): ?>
                                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>
                                        <?php elseif($nIcon === 'danger'): ?>
                                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><line x1="15" y1="9" x2="9" y2="15"/><line x1="9" y1="9" x2="15" y2="15"/></svg>
                                        <?php elseif($nIcon === 'warning'): ?>
                                    ...
                                    <div class="notif-item-body">
                                        <div class="notif-item-title"><?php echo e($notif->data['title'] ?? 'Notification'); ?></div>
                                        <div class="notif-item-msg"><?php echo e(\Illuminate\Support\Str::limit($notif->data['message'] ?? '', 65)); ?></div>
                            ...
                            <a href="<?php echo e(route('notifications.index')); ?>" class="notif-view-all">View all notifications</a>
                        </div>
                    </div>
                    ...
                    <div class="profile-dropdown" id="profileDropdown">
                        <button class="profile-trigger" onclick="toggleProfileDropdown(event)" aria-expanded="false" aria-haspopup="true">
                            ...
                            <div class="profile-trigger-info">
                                <span class="profile-trigger-name"><?php echo e(auth()->user()->name); ?></span>
                                <span class="profile-trigger-role"><?php echo e(ucfirst(auth()->user()->role)); ?></span>
                            </div>
                        ...
                        <div class="profile-menu" id="profileMenu" role="menu">
                            <div class="profile-menu-header">
                                <div class="profile-menu-avatar"><?php echo e(strtoupper(substr(auth()->user()->name, 0, 1))); ?></div>
                                <div>
                                    <div class="profile-menu-name"><?php echo e(auth()->user()->name); ?></div>
                                    <div class="profile-menu-email"><?php echo e(auth()->user()->email); ?></div>
                                    <?php
                                    ...
                                    ?>
                                    <?php if($prevLogin): ?>
                                        <div class="profile-menu-last-login" title="<?php echo e($prevLogin->format('d M Y, g:i A')); ?>">
                                            Last login: <?php echo e($prevLogin->diffForHumans()); ?>
                            ...
                            <?php if(auth()->user()->isAdmin()): ?>
                                <a href="<?php echo e(route('settings.index')); ?>" class="profile-menu-item" role="menuitem">
    ...
    <div id="chatbot-panel" class="hidden" role="dialog" aria-label="HR Assistant">
        ...
        <div id="chatbot-messages">
            <div class="cb-msg bot">Hi <?php echo e(auth()->user()->name); ?>! I can answer questions about your payroll, attendance, leave, and performance. How can I help?</div>
        </div>
...
<?php /**PATH C:\Users\ishma\Music\iims\resources\views/layouts/app.blade.php ENDPATH**/ ?>