...
@section('content')
    <div class="card" style="max-width: 800px;">
        ...
        <form action="{{ route('employees.store') }}" method="POST">
            ...
            <div class="alert alert-info" style="margin-bottom:1rem;display:flex;align-items:center;gap:0.5rem;font-size:0.875rem;">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>
                A secure password will be auto-generated. The employee will receive an email with a link to set their own password.
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" id="phone" name="phone" class="form-control"
                           value="{{ old('phone') }}" placeholder="+232-XX-XXXXXXX">
                </div>
                <div class="form-group">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <select id="contract_type" name="contract_type" class="form-control" required onchange="toggleContractDate(this.value)">
                        ...
                        <option value="fixed-term"  {{ old('contract_type') === 'fixed-term'  ? 'selected' : '' }}>Fixed-Term</option>
                        <option value="probation"   {{ old('contract_type') === 'probation'   ? 'selected' : '' }}>Probation</option>
                    </select>
                </div>
                <div class="form-group" id="contract_end_group" style="{{ in_array(old('contract_type'), ['fixed-term','probation']) ? '' : 'display:none' }}">
                    <label class="form-label" for="contract_end_date">Contract End Date <span id="contract_end_required" style="{{ old('contract_type') === 'fixed-term' ? '' : 'display:none' }}">*</span></label>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" id="basic_salary" name="basic_salary" class="form-control"
                           value="{{ old('basic_salary', '0') }}" step="0.01" min="0" required>
                </div>
                <div class="form-group">
            ...
            <div class="mt-3">
                <button type="submit" class="btn btn-primary">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1-2 2h14l2 2v12a2 2 0 0 1-2 2z"/><polyline points="17 21 17 13 7 13 7 21"/><polyline points="7 3 7 8 15 8"/></svg>
                    Create Employee
                </button>
